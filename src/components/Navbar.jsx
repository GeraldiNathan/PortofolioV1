...
export const Navbar = () => {
  ...
  return (
    <div className="navbar md:py-4 flex items-center justify-between sticky top-0 md:backdrop-blur-3xl z-10">
      ...
      <ul
        className="menu flex flex-wrap justify-between fixed bottom-0 left-1/2 -translate-x-1/2 md:-translate-0 
        md:sticky md:top-0 items-center md:gap-10 md:opacity-100 w-full md:w-fit px-4 py-2 md:py-4 rounded-tl-2xl 
        rounded-tr-2xl transition-all md:transition-none bg-gray-300 dark:bg-zinc-700 md:bg-transparent 
